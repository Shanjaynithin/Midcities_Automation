...
public class Equipment_Negative_Case extends BaseClass {
	
	@Test
	public void equipmentNegative() throws AWTException, InterruptedException {
	
	logger = reports.createTest("Create equipment negative case");
